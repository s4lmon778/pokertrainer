 ...
 */
export function precomputeDiscounts(t) {
 ...
 */
export function encodeSignedSlice(src) {
    let maxAbs = 0;
 ...
 */
export function decodeWithDiscount(compressed, scale, posDiscount, negDiscount) {
 ...
 */
export function regretMatching(regrets) {
    let sumPositive = 0;
 ...
 */
export class DCFRImpl {
    constructor(numHands, numActions) {
     ...
     */
    updateRegrets(actionUtils, cfReachProb, iteration) {
 ...
 */
export function createDCFRModule(numActions) {
 ...
 */
export function cfrTraversal(node, heroReachProb, villainReachProb, iteration, depth = 0) {
    ...
    if (node.type === 'ACTION') {
        ...
        const actionUtils = new Array(numActions);
 ...
 */
function uniformStrategy(numActions) {
 ...
 */
export function solveDCFR(root, iterations = 100, minExploitability, onProgress) {
 ...
 */
function computeExploitability(root) {
 ...
 */
function bestResponseValue(node, respondingPlayer) {
    if (node.type === 'TERMINAL') {
 ...
 */
function expectedValue(node, playerIndex) {
    if (node.type === 'TERMINAL') {
